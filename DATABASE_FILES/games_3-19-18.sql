...
--
-- Host: localhost
-- Generation Time: Mar 19, 2014 at 05:51 AM
...
INSERT INTO `gamehistory` (`username`, `user_idnum`, `baseball`, `soccer`, `football`, `tennis`, `frisbee`, `rugby`, `basketball`, `hockey`) VALUES
('', 1, 20, 27, 20, 25, 26, 28, 19, 5),
('taylor', 1, 5, 6, 7, 0, 8, 9, 2, 1);
