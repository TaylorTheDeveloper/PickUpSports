<?php //Query Database
	...
	echo "<input type=\"url\"  readonly=\"readonly\" name=\"matchlink\" id=\"matchlink\" parsley-required=\"false\"  autofocus type=\"text\" class=\"form-control\" name=\"matchlink\" value=\"". $linkImp ."\" placeholder=\"". $link ."\">";
	echo "</div></tr></td>";
