        ...
        a.prototype = {
            ...
            render: function (a) {
                var g = this,
                    ...
                    z = b.dowNames || "Su Mo Tu We Th Fr Sa".split(" "),
                ...
                for (l = e = 0; 7 > e; e++)
                    for (var q = 0; 7 > q; q++, l++) {
                        ...
                        if (e) {
                            ...
                            }!s || 0 > v._indexOf(p.year) || 0 > H._indexOf(p.month) || 0 > y._indexOf(p.day) ? n = "noday" : (n = "su mo tu we th fr sa".split(" ")[p.day], I != p.month && (n += " outday"), u == x && (n = "today", r += 50), b.selectedDate._time() == x && (n = "selected", r += 51), b.specialDates && $.each(b.specialDates, function (b, a) {
                                D(a, a.date).time ==
