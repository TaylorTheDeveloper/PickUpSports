...
<div class="container">
	<div class="row clearfix" >
		  <div class="panel-heading" style="color:#fa7147;">
            ...
            <br><div><center>
            <h1 class="newgameHeader"><span class="entypo-trophy" > </span> Edit Match</center></div></h1>
            <hr>
        	</div>     
		...
		<div class="col-md-6 column well">
			...
			<form role="form" class="form-horizontal" method="post" action="matches/update_match.php" parsley-validate >
